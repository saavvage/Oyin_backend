...
### Система монет (Wallet)

- **Ежедневная награда**: 10 → 20 → 30 → 40 → 50 → 60 → 500 монет (7-дневная серия)
- **Победа в челлендже**: +25 монет
- **Проигрыш в челлендже**: +5 монет (за участие)
- **Ничья**: +10 монет каждому
- **Покупки**: магазин товаров за монеты
